...
void Recepcjonista::Przegladaj_pokoje() {
	// TODO - implement Recepcjonista::Przegladaj_pokoje
	throw "Not yet implemented";
}

void Recepcjonista::Przegladaj_rezerwacje() {
	// TODO - implement Recepcjonista::Przegladaj_rezerwacje
	throw "Not yet implemented";
}

void Recepcjonista::Przegladaj_klientow() {
	// TODO - implement Recepcjonista::Przegladaj_klientow
	throw "Not yet implemented";
}

boolean Recepcjonista::Dodaj_rezerwacje() {
...
boolean Recepcjonista::Dodaj_klienta() {
